"""Contains methods and classes to collect py_wrapper from
...
class CryptoDataDownload:
    """Provides methods for retrieving py_wrapper on different cryptocurrencies from
    https://www.cryptodatadownload.com/cdd/.

    Attributes
    ----------
    url : str
        The url for collecting py_wrapper from CryptoDataDownload.

    Methods
    -------
    fetch(exchange_name,base_symbol,quote_symbol,timeframe,include_all_volumes=False)
        Fetches py_wrapper for different exchanges and cryptocurrency pairs.
    ...
    def fetch_default(self,
        ...
        """Fetches py_wrapper from all exchanges that match the evaluation structure.
        ...
        timeframe : {"d", "h", "m"}
            The timeframe to collect py_wrapper from.
    ...
    def fetch_gemini(self,
        ...
        """
        Fetches py_wrapper from the gemini exchange.
